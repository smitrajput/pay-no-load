...
class Contract extends Component<IMyProps, IMyState> {
 // ParamsRow: (props: any) => JSX.Element;
 // getContractDetails: () => Promise<void>;
 // getTokenDetails: () => Promise<void>;
 // getTokenBalance: () => Promise<void>;
 // getTransactions: () => Promise<void>;
 // TxnRow: (props: any) => JSX.Element;
 // decodeFromLatest: (txnDetails: any) => Promise<void>;
 // getTransactionAndDecode: () => Promise<JSX.Element | undefined>;
 // decodeParams: () => Promise<void>;
...
getContractDetails = async () => {
 ...
 let request = "https://api.aleth.io/v1/contracts/0x2af47a65da8CD66729b4209C22017d6A5C2d2400"
 await fetch(request, {
  method: "GET",
  headers: {
...
getTokenDetails = async () => {
 // // // console.log("this is contract. hurray");
 let request = `https://api.aleth.io/v1/tokens/${this.state.token_contract_address}`
 await fetch(request, {
     method: "GET",
     title: "",
     contract_details: "",
 ...
 .then((json: any) => {
    ...
    getTransactions = async () => {
        ...
        // let data;
        try{
            let request = `https://api.aleth.io/v1/contracts/${this.state.contract_address}/transactions`
            await fetch(request, {
            method: "GET",
            headers: {
                "username":"main_k5ua5idae7skpuciub5afanpxys3q",
    ...
    getTransactionAndDecode = async () => {
        ...
        try{
            let request = `https://api.aleth.io/v1/transactions/${this.state.transaction_hash}`
            await fetch(request, {
            method: "GET",
            headers: {
                "username":"main_k5ua5idae7skpuciub5afanpxys3q",
    ...
    decodeFromLatest = async(txnDetails: any) => {
        ...
        // try{
            ...
            let request = `https://api.aleth.io/v1/transactions/${txnDetails.id}`
            await fetch(request, {
            method: "GET",
            headers: {
                "username":"main_k5ua5idae7skpuciub5afanpxys3q",
